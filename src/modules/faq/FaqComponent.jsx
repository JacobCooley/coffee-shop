		...
		<div>
			...
			<ul>
				<li><h3>What are smart contracts?</h3><p>A smart contract is a piece of software that contains rules and
					...
					executes the agreed upon terms.</p></li>
				...
				<li><h3>How much does your service cost?</h3><p>Depending on the chain and the contract you want the
					price
					will be different. Select "Create" at the top and you can see a list of our products.</p></li>
				<li><h3>Can you make me a custom contract?</h3><p>Absolutely! Contact us and we can arrange a time to
					speak
				...
				<li><h3>Can I upload my own smart contract?</h3><p>Definitely! Contact us and we will let you know about
					our
